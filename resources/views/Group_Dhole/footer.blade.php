            ...
            <div class="col-lg-4 col-md-6 footer-about">
                <div class="d-flex flex-column justify-content-center  h-100 bg-primary p-4">
                    <a href="index.html" class="navbar-brand ">
                       <div class="ml-3">
                        <h1 class="m-0 d-none d-md-flex d-sm-flex "><img class="w-50" src="/images/logo1.png" alt="" ></h1>
                        <h1 class="m-0 d-md-none d-sm-none"><img class="w-25" src="/images/logo1.png" alt="" ></h1>
                       </div>
                    </a>
                    <p class="mt-3 mb-4">
                        GROUP-DHOLE on luotettava asiantuntijasi kestävien konttien ja kestävän polttopuun hankinnassa, tarjoten laadukkaita ratkaisuja ja esimerkillistä asiakaspalvelua. 
                        Luota asiantuntemuksemme täyttämään tarpeitasi täysin tyytyväisenä.
                    </p>
                    <form action="">
                ...
                <div class="row gx-5">
                    <div class="col-lg-4 col-md-12 pt-5 mb-5">
                        <div class="section-title section-title-sm position-relative pb-3 mb-4">
                            <h3 class="text-light mb-0">Ota yhteyttä</h3>
                        </div>
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <p class="mb-0">contact@group-dhole.com</p>
                        </div>
                        <div class="d-flex mb-2">
                            <i class="bi bi-telephone text-primary me-2"></i>
                            <p class="mb-0">+44 7441 427902</p>
                        </div>
        ...
        <div class="row justify-content-end">
            <div class="col-lg-8 col-md-6">
                <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                    <p class="mb-0">&copy; <a class="text-white border-bottom" href="#" translate="no">GROUP-DHOLE</a>. All Rights Reserved. 
