...
<body>
        ...
        <div class="container-fluid bg-primary py-5 bg-headerss" style="">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn text-uppercase">TIIVITEETTY CREPITO LOKIT</h1>
                    <a href="" class="h5 text-white">Koti</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Crepito</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var image = document.getElementById('myImage');
            ...
            image.src = '/images/produit2bois.jpeg';
        
        }
        function changeImage2() {
        var image = document.getElementById('myImage');
       
            image.src = '/images/op21.jpg';
    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            <div class="d-flex flex-wrap col-4 ">
                <img  id="myImage" src="/images/produit2bois.jpeg" style="max-height:250px; ">
            </div>
            <div class="m-4 d-flex flex-row flex-wrap">
               
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage1()"><img src="/images/produit2bois.jpeg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage2()"><img src="/images/op21.jpg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            <div class="mb-2 mx-4"><h3 style="color: #F49122; margin-bottom:20px;"> TIIVITEETTY CREPITO LOKIT</h3></div>
            <div class="d-flex flex-row mb-2 flex-wrap mx-4">
                ...
                <div class="mx-4"><h5 class="" style="color: #c5bebe">205 <span class=""style="color:black;">Tähtiarviointi</span></h5></div>
                <div class="ml-4"><h5 class="" style="color: #c5bebe">10004 <span class="text-primary">Myyty</span></h5></div>
                


            </div>
            <div class="mb-2 mx-4">  <h3 class="text-primary">465€ HT</h3></div>


            <p class="mx-4">Tiivistetyt Crépito®-tukit ovat 3–4 kertaa tehokkaampia kuin perinteiset polttopuut ja vaativat 4 kertaa vähemmän varastotilaa.


                Saadaksesi selville tiivistetukkien lavallesi hinnat, syötä postinumerosi, valitse pakkaus ja haluamasi määrä. Noudata ohjeita. Mahdolliset toimituskulut lisätään ostoskoriin. </p>
                ...
                <p class="mx-4">
                    ...
                    <ul>
                        <li><span class="text-primary">TIHEYS ≤ </span>1000 kg.m-3</li>
                        <li><span class="text-primary">KOSTEUSTASO </span>≤ 10 %</li>
                        <li><span class="text-primary">PCI brutto(1) </span>4,6 kWh.kg-1 ≤ PCI ≤ 5 kWh.kg-1 </li>
