...
<body>
    ...
    <script>
        ...
        var image = document.getElementById('myImage');
            ...
            image.src = '/images/bois3.jpg';
        
        }
        function changeImage2() {
        var image = document.getElementById('myImage');
       
            image.src = '/images/458.jpg';
    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            <div class="d-flex flex-wrap col-4 ">
                <img  id="myImage" src="/images/bois3.jpg" style="max-height:250px; ">
            </div>
            <div class="m-4 d-flex flex-row flex-wrap">
               
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage1()"><img src="/images/bois3.jpg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage2()"><img src="/images/458.jpg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            ...
            <div class="d-flex flex-row mb-2 flex-wrap mx-4">
                ...
                <div class="ml-4"><h5 class="" style="color: #c5bebe">741 <span class="text-primary">Myyty</span></h5></div>
                


            </div>
            <div class="mb-2 mx-4">  <h3 class="text-primary">315 € HT</h3></div>


            <p class="mx-4">

                Pieniksi paloiksi leikatut, kuivatut, osittain kuoritut ja pakatut Premium Crépito® -tukit mahdollistavat 30 % vähemmän puunkulutuksen*.  </p>
...
Käyttövalmis, Premium Crépito® -tukkien käsittely on yksinkertaista ja pölytöntä. Ne helpottavat puulämmitteisen laitteen sytytystä ja varmistavat optimaalisen palamisen, tuottavat 2–3 kertaa vähemmän tuhkaa*.

Ainutlaatuinen valmistusprosessi
Crépito® Premium -tukilla on korkea lämpöarvo. Ne poltetaan nopeasti ja ne voivat palauttaa mukavan lämmön erittäin nopeasti erittäin alhaisella tuhkapitoisuudella.

Tämä tarjoaa maksimaalisen energiatehokkuuden ja pidentää lämmittimen ja kanavan käyttöikää. Puulämmitteisten laitteiden uusiin teknisiin vaatimuksiin vastaaminen.

Premium Crépito® -tukit ovat NF-sertifioituja ja niitä valvotaan jatkuvasti CERIC-laboratoriossa.

* Verrattuna perinteiseen polttopuuhun, jonka kosteus on ≈ 35 %
        </p>
    </div>
