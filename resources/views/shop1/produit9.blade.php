...
<body>
            ...
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h3 class="display-4 text-white animated zoomIn text-uppercase">
                        Puolilava uunikuivattua </h3>
                    <a href="" class="h5 text-white">Koti</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Tammipolttopuuta</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var image = document.getElementById('myImage');
            ...
            image.src = '/images/produit9bois.jpeg';
    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            <div class="d-flex flex-wrap col-4 ">
                <img  id="myImage" src="/images/produit9bois.jpeg" style="max-height:250px; ">
            </div>
            <div class="m-4 d-flex flex-row flex-wrap">
               
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage1()"><img src="/images/produit9bois.jpeg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            ...
            <div class="d-flex flex-row mb-2 flex-wrap mx-4">
                ...
                <div class="mx-4"><h5 class="" style="color: #c5bebe">584 <span class=""style="color:black;">Tähtiarviointi</span></h5></div>
                <div class="ml-4"><h5 class="" style="color: #c5bebe">1978 <span class="text-primary">Myyty</span></h5></div>
                


            </div>
            <div class="mb-2 mx-4">  <h3 class="text-primary">359€ HT</h3></div>
            ...
            <p class="mx-4">
               ...
               <ul>
                    <li>
                        Kosteus alle 20 %</li>
                    <li> Pehmeä puu, palaa nopeasti </li>
                    <li>Valmisaja:  Tapiowood</li>
                    <li>Suoraan poltettavissa</li>
                    <li>Lohkon pituus: 23/25 cm</li>
                    <li>Keskikokoisille ja suurille liesille</li>
                </ul>
            </p>
    ...
    <div class="container mt-5">
        <p class="mx-4 mt-5">
            Tammipuussa on vilkas, räiskyvä liekki ja se antaa ihanan tuoksun. 
            Tannien (happojen) vuoksi on tärkeää lämmittää se korkealle 4 lohkolla samanaikaisesti, jotta saadaan hyvä palaminen.  </p>
    </div>
