...
<body>
            ...
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn text-uppercase">
                        88 pussia uunikuivattua saarnia</h1>
                    <a href="" class="h5 text-white">Koti</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">88 pussia</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var image = document.getElementById('myImage');
            ...
            image.src = '/images/produit4bois.jpeg';
    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            <div class="d-flex flex-wrap col-4 ">
                <img  id="myImage" src="/images/produit4bois.jpeg" style="max-height:250px; ">
            </div>
            <div class="m-4 d-flex flex-row flex-wrap">
               
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage1()"><img src="/images/produit4bois.jpeg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            <div class="mb-2 mx-4"><h3 style="color: #F49122; margin-bottom:20px;"> 88 pussia uunikuivattua saarnia</h3></div>
            <div class="d-flex flex-row mb-2 flex-wrap mx-4">
                ...
                <div class="mx-4"><h5 class="" style="color: #c5bebe">201 <span class=""style="color:black;">Tähtiarviointi</span></h5></div>
                <div class="ml-4"><h5 class="" style="color: #c5bebe">9504 <span class="text-primary">Myyty</span></h5></div>
                


            </div>
            <div class="mb-2 mx-4">  <h3 class="text-primary">625€ HT</h3></div>


            <p class="mx-4">
             
                <ul>
                    <li>Tuhkapuuta verkoissa</li>
                    <li>Uunissa kuivattua</li>
                    <li>Kosteus alle 20 %</li>
                    <li>Voidaan säilyttää suoraan</li>
                    <li>Lehtipuutyyppi, palaa pitkään</li>
                    <li>Lohkon pituus: 25 cm</li>
                    <li>Keskikokoisille ja suurille pannuille</li>
                </ul>
            </p>
    ...
    <div class="container mt-5">
        <p class="mx-4 mt-5">
            88 pussia uunikuivattua saarnia
            Ihanteellinen suurille uuneille ja tulisijoille. Palaa erittäin helposti ja tarjoaa miellyttävää lämpöä. Ei laatikkoa ja helppo siirtää verkkojen ansiosta.
