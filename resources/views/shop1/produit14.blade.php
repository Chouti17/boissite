...
<body>
    ...
    <script>
        ...
        var image = document.getElementById('myImage');
            ...
            image.src = '/images/produit14bois.jpeg';
    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            <div class="d-flex flex-wrap col-4 ">
                <img  id="myImage" src="/images/produit14bois.jpeg" style="max-height:250px; ">
            </div>
            <div class="m-4 d-flex flex-row flex-wrap">
               
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage1()"><img src="/images/produit14bois.jpeg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            ...
            <div class="d-flex flex-row mb-2 flex-wrap mx-4">
                ...
                <div class="ml-4"><h5 class="" style="color: #c5bebe">7441 <span class="text-primary">Myyty</span></h5></div>
            ...
            <p class="mx-4">
                ...
                RUF-lava 1000 kg - Lehtipuubriketit - Neliönmuotoinen - Takka - Savustin - Lämmitys - Polttopuut - Ekologiset puubriketit - 1 lava - Energie Kienbacher
               </p>
