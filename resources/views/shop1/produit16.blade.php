    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            <div class="d-flex flex-wrap col-4 ">
                <img  id="myImage" src="/images/bois4.jpg" style="max-height:250px; ">
            </div>
            <div class="m-4 d-flex flex-row flex-wrap">
               
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage1()"><img src="/images/bois4.jpg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            ...
            <div class="mb-2 mx-4">  <h3 class="text-primary">375€ HT</h3></div>
            ...
            <p class="mx-4">
                ...
                <ul>
                    <li><span class="text-primary">Koostumus:</span>100% hartsimainen</li>
                    <li><span class="text-primary">Sertifikaatit:</span> DIN Plus, EN Plus A1</li>
                    <li><span class="text-primary">Kosteusaste: </span>alle 10 %</li>
                    <li><span class="text-primary">Tuhkapitoisuus:</span> alle 0,7 %</li>
                    <li><span class="text-primary">Pölynopeus: </span>alle 0,5 %</li>
                    <li><span class="text-primary">Halkaisija:</span> 6 mm</li>
                    <li><span class="text-primary">Pakkaus: </span>Lava</li>
                    <li><span class="text-primary">Alkuperä: </span>Belgia</li>
                </ul>
