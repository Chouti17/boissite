...
<body>
        ...
        <div class="container-fluid bg-primary py-5 bg-headerss" style="">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    ...
                    <a href="" class="h5 text-white">40 pussia</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var image = document.getElementById('myImage');
            ...
            image.src = '/images/produit11bois.jpeg';
    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            <div class="d-flex flex-wrap col-4 ">
                <img  id="myImage" src="/images/produit11bois.jpeg" style="max-height:250px; ">
            </div>
            <div class="m-4 d-flex flex-row flex-wrap">
               
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage1()"><img src="/images/produit11bois.jpeg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            <div class="mb-2 mx-4"><h3 style="color: #F49122; margin-bottom:20px;"> 
                40 pussia kuivattua saarnia 8 kg</h3></div>
            ...
            <div class="mb-2 mx-4">  <h3 class="text-primary">349€ HT</h3></div>
    ...
    <div class="container mt-5">
        <p class="mx-4 mt-5">
            40 pussia luukuivia leppäpolttopuita. Leppä on lehtipuu, joka palaa kauniin puhtaana. Puu on 25 cm ja keskihalkaisija.  </p>
