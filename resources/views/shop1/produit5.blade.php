...
<body>
    ...
    <script>
        ...
        var image = document.getElementById('myImage');
            ...
            image.src = '/images/produit5bois.jpeg';
    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            ...
            <div class="m-4 d-flex flex-row flex-wrap">
                ...
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage1()"><img src="/images/produit5bois.jpeg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            <div class="mb-2 mx-4"><h3 style="color: #F49122; margin-bottom:20px;"> 
                Paletti uunikuivattu leppä</h3></div>
            <div class="d-flex flex-row mb-2 flex-wrap mx-4">
                ...
                <div class="mx-4"><h5 class="" style="color: #c5bebe">288 <span class=""style="color:black;">Tähtiarviointi</span></h5></div>
                <div class="ml-4"><h5 class="" style="color: #c5bebe">18524 <span class="text-primary">Myyty</span></h5></div>
                


            </div>
            <div class="mb-2 mx-4">  <h3 class="text-primary">427.99€ HT</h3></div>
            ...
            <p class="mx-4">Leppä soveltuu hyvin pieniin uuneihin,
                <ul>
                    ...
                    <li>Helppo polttaa</li>
                    <li>Lohkon pituus: 25 cm</li>
                    <li> Sopii kaikille liesille</li>
                </ul>
            </p>
    ...
    <div class="container mt-5">
        <p class="mx-4 mt-5">
            Elzenissä on erittäin puhdas palaminen, joten uunin ikkunan ja savupiippujen kerrostumat eivät häiritse sinua. 
            Leppäpolttopuut sopivat sekä pieniin uuneihin että suuriin tulisijoihin. Leppäpolttopuulla on ihana tuoksu ja helppo palaminen..
