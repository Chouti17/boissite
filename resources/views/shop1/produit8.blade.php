...
<body>
            ...
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h3 class="display-4 text-white animated zoomIn text-uppercase">
                        Puolilava uunikuivattua koivupolttopuuta</h3>
                    <a href="" class="h5 text-white">Koti</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Puolilava uunikuivattua koivupolttopuuta</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var image = document.getElementById('myImage');
            ...
            image.src = '/images/produit8bois.jpeg';
    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            <div class="d-flex flex-wrap col-4 ">
                <img  id="myImage" src="/images/produit8bois.jpeg" style="max-height:250px; ">
            </div>
            <div class="m-4 d-flex flex-row flex-wrap">
               
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage1()"><img src="/images/produit8bois.jpeg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            <div class="mb-2 mx-4"><h3 style="color: #F49122; margin-bottom:20px;"> 
                Puolilava uunikuivattua koivupolttopuuta</h3></div>
            ...
            <div class="mb-2 mx-4">  <h3 class="text-primary">329€ HT</h3></div>
            ...
            <p class="mx-4">
                    ...
                    <li>Koivu sopii hyvin pieniin uuneihin Uunissa kuivattu</li>
                    <li>
                        Kosteus alle 20 %</li>
    ...
    <div class="container mt-5">
        <p class="mx-4 mt-5">
            Koivun lämpöominaisuudet ovat erittäin hyvät. Kauniiden liekkien lisäksi koivulla on puhdas palaminen.
             Näin savupiippusi jäämät eivät häiritse sinua ja kiukaan ikkuna pysyy kauniina ja puhtaana. Polttopuut valmistetaan käsin ja toimitetaan tiiviisti pinottuina.  </p>
    </div>
