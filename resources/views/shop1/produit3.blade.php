...
<body>
        ...
        <div class="container-fluid bg-primary py-5 bg-headerss" style="">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    ...
                    <a href="" class="h5 text-white">Havupuu</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var image = document.getElementById('myImage');
            ...
            image.src = '/images/produit3bois.jpeg';
        
        }
        function changeImage2() {
        var image = document.getElementById('myImage');
       
            image.src = '/images/ac.png';
        
        }
        function changeImage3() {
        var image = document.getElementById('myImage');
       
            image.src = '/images/ad.jpeg';
        
        }
        function changeImage4() {
        var image = document.getElementById('myImage');
       
            image.src = '/images/ae.jpeg';
    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            <div class="d-flex flex-wrap col-4 ">
                <img  id="myImage" src="/images/produit3bois.jpeg" style="max-height:250px; ">
            </div>
            <div class="m-4 d-flex flex-row flex-wrap">
               
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage1()"><img src="/images/produit3bois.jpeg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage2()"><img src="/images/ac.png" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage3()"><img src="/images/ad.jpeg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage4()"><img src="/images/ae.jpeg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            ...
            <div class="d-flex flex-row mb-2 flex-wrap mx-4">
                ...
                <div class="mx-4"><h5 class="" style="color: #c5bebe">2041 <span class=""style="color:black;">Tähtiarviointi</span></h5></div>
                <div class="ml-4"><h5 class="" style="color: #c5bebe">8504 <span class="text-primary">Myyty</span></h5></div>
                


            </div>
            <div class="mb-2 mx-4">  <h3 class="text-primary">200€ HT</h3></div>


            <p class="mx-4">Erikoispuukiuasmassa – uunikuivattu – käyttövalmis – havupuu/lehtipuu
                Lava kaksi kuutiometriä uunikuivattua polttopuuta, joka on valmistettu erityisesti massauuniin. Kuivauksen aikana säädelty kosteus, taattu alle 20 % maksimaalisen tuoton saavuttamiseksi.
                
                Valitut lajit: koivu, kuusi, saarni, poppeli, pyökki korkeaan palamislämpötilaan ja hienoksi halkaistu, jotta se palaa nopeasti.</p>
    ...
    <div class="container mt-5">
        <p class="mx-4 mt-5">
            Pakkaus 2 kuutiometriä 33cm (1 lava)
            Pituus 33 cm (enemmän tai vähemmän 3 cm)
            Osa 8-18 cm
            Pääasiassa tammi- ja pyökkipuulajit
            Origin Center ja Burgundin alueet
            Kosteusaste Kuiva puu: luonnollinen kuivuminen 4 vuotta, yli 25 %
            Varastointi Varastoi tuuletetussa paikassa
            Kuivaus Kuiva puu: luonnollinen kuivaus – ekologinen
            Paletti
            Lavojen pakkaus Tukit, jotka on kääritty irtotavarana lavoille (kalvo on verkko, joka antaa puun hengittää)
            Lavan mitat 100cm*120cm maassa ja korkeus noin 180cm
            Paino per lava 700kg (likimääräinen - ei sopimusta)
            Lavan kapasiteetti 2 steriä
            Käyttövalmis Kyllä
            Laatu
            Metsänhoito Puu kestävästi hoidetuista metsistä
            NF-sertifikaatti
