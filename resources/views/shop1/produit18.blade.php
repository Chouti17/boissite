    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            <div class="d-flex flex-wrap col-4 ">
                <img  id="myImage" src="/images/bois2.jpg" style="max-height:250px; ">
            </div>
            <div class="m-4 d-flex flex-row flex-wrap">
               
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage1()"><img src="/images/bois2.jpg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            <div class="mb-2 mx-4"><h3 style="color: #F49122; margin-bottom:20px;"> 
                valkoinen tammi ja pyökki</h3></div>
            <div class="d-flex flex-row mb-2 flex-wrap mx-4">
                ...
                <div class="mx-4"><h5 class="" style="color: #c5bebe">3745 <span class=""style="color:black;">Tähtiarviointi</span></h5></div>
                <div class="ml-4"><h5 class="" style="color: #c5bebe">25004 <span class="text-primary">Myyty</span></h5></div>
                


            </div>
            <div class="mb-2 mx-4">  <h3 class="text-primary">147€ HT</h3></div>


            <p class="mx-4">

                <ul>
                    <li><span class="text-primary">Lajit:</span>valkoinen tammi, pyökki tai valkopyökki</li>
                    <li><span class="text-primary">Alkuperä:</span> 100 % ranskalaista puuta</li>
                    <li><span class="text-primary">Pituus:</span>40 cmi</li>
                    <li><span class="text-primary">Määrä:</span>6 STERES (4,61 m3)</li>
                    <li><span class="text-primary">Myyntiyksikkö:</span> 2 lavaa</li>
                </ul> 
