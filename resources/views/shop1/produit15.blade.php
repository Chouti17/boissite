...
<body>
            ...
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    ...
                    <a href="" class="h5 text-white"> 
                        ...
                        Nestro pyökki- ja tammibriketit 300 kg</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var image = document.getElementById('myImage');
            ...
            image.src = '/images/produit15bois.jpeg';
    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            <div class="d-flex flex-wrap col-4 ">
                <img  id="myImage" src="/images/produit15bois.jpeg" style="max-height:250px; ">
            </div>
            <div class="m-4 d-flex flex-row flex-wrap">
               
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage1()"><img src="/images/produit15bois.jpeg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            <div class="mb-2 mx-4"><h3 style="color: #F49122; margin-bottom:20px;"> 
                Nestro pyökki- ja tammibriketit 300 kg</h3></div>
            <div class="d-flex flex-row mb-2 flex-wrap mx-4">
                ...
                <div class="ml-4"><h5 class="" style="color: #c5bebe">74741 <span class="text-primary">Myyty</span></h5></div>
                


            </div>
            <div class="mb-2 mx-4">  <h3 class="text-primary">872€ HT</h3></div>


            <p class="mx-4">

                Pakkauksen kanssa | lava | toimitus (ilman saaria) | pieninäkin annoksina annetaan sama energiasisältö
                30 polyeteenipussia 10 kg = 300 kg lava Nestro-brikettejä<br>
                - Nämä briketit on erittäin helppo rikkoa ja sopivat siksi ihanteellisesti pieniin kotitalouksiin - 5/6 Nestro-brikettiä 10 kg pussia kohti
                Laadukkaat kovapuubriketit tammi- ja pyökkilastuista - Pituus: n. 30/40 cm - Halkaisija: n. 8/9 cm <br>
                CO2-neutraali - Korkea energiaarvo ja pitkä palamisaika - Luonnollisesti puristettu ilman sideainetta - Alhainen tuhkapitoisuus - Välitön käyttö - Nopea lämmönkehitys - Voidaan käyttää kaikissa takkauuneissa, kaakeliuunissa, puukamiinoissa, yksittäisissä tulisijoissa
               </p>
