...
<body>
        ...
        <div class="container-fluid bg-primary py-5 bg-headerss" style="">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    ...
                    <a href="" class="h5 text-white">polttopuut</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var image = document.getElementById('myImage');
            ...
            image.src = '/images/produit10bois.jpeg';
    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            <div class="d-flex flex-wrap col-4 ">
                <img  id="myImage" src="/images/produit10bois.jpeg" style="max-height:250px; ">
            </div>
            <div class="m-4 d-flex flex-row flex-wrap">
               
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage1()"><img src="/images/produit10bois.jpeg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage2()"><img src="/images/n4.jpg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage3()"><img src="/images/n5.jpg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            <div class="mb-2 mx-4"><h3 style="color: #F49122; margin-bottom:20px;"> 
                Kuiva puu valmiina poltettavaksi</h3></div>
            <div class="d-flex flex-row mb-2 flex-wrap mx-4">
                ...
                <div class="mx-4"><h5 class="" style="color: #c5bebe">574 <span class=""style="color:black;">Tähtiarviointi</span></h5></div>
                <div class="ml-4"><h5 class="" style="color: #c5bebe">84178 <span class="text-primary">Myyty</span></h5></div>
                


            </div>
            <div class="mb-2 mx-4">  <h3 class="text-primary">620€ HT</h3></div>


            <p class="mx-4">
                
                Lava, jonka tilavuus on 2 kuutiometriä uunikuivattua polttopuuta, tiukasti pinottu.
                 Polttoaineseos koostuu tammi-, pyökki- ja/tai saarnipuusta. Puu on kuivaa ja valmis palamaan. Kaksi laatikkoa asetetaan päällekkäin.
            </p>
    ...
    <div class="container mt-5">
        <p class="mx-4 mt-5">
            Polttoaineseos polttopuuhäkki 2 kuutiota uunikuivattua
Lavalämmitys sekoitettu polttopuu, jonka tilavuus on 2 kuutiota. Uunissa kuivatut polttopuut tiukasti pinottuna laatikossa. Polttoaineseos koostuu tammi-, pyökki- ja/tai saarnipuusta. Puu on kuivaa ja valmis palamaan.
 Kaksi kuutiometriä pinottu polttopuuta vastaa noin 3 kuutiota löysästi kaadettua polttopuuta. Lohkot ovat neliömäisiä ja helppo pinota. Kaksi laatikkoa asetetaan päällekkäin.
        </p>
