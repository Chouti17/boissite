...
<body>
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center mt-4 flex-wrap">
        ...
        <div class="col-md-6 col-lg-4 row mb-2">
            ...
            <div class="d-flex flex-column justify-content-center align-items-center">
                ...
                <div class="product__item__text text-center">
                    <h6><a href="">TIIVITEETTY CREPITO LOKIT</a></h6>
    ...
    <div class="col-md-6 col-lg-4 row mb-2">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="product__item__text text-center">
                <h6><a href="">Havupuu/Lehtipuu</a></h6>
    ...
    <div class="col-md-6 col-lg-4 row mb-2 mt-4">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="product__item__text text-center">
                <h6><a href="">88 pussia uunikuivattua saarnia</a></h6>
    ...
    <div class="col-md-6 col-lg-4 row mb-2 mt-4">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="product__item__text text-center">
                <h6><a href="">Paletti uunikuivattu leppä</a></h6>
    ...
    <div class="col-md-6 col-lg-4 row mb-2 mt-4">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="product__item__text text-center">
                <h6><a href="">Paletti uunikuivattu pyökki 30 cm</a></h6>
    ...
    <div class="col-md-6 col-lg-4 row mb-2 mt-4">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="product__item__text text-center ">
                <h6><a href="">Puubriketti LP Täysi Lava Puubrikettejä</a></h6>
    ...
    <div class="col-md-6 col-lg-4 row mb-2 mt-4">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="product__item__text text-center">
                <h6><a href="">Puolilava uunikuivattua koivupolttopuuta</a></h6>
    ...
    <div class="col-md-6 col-lg-4 row mb-2 mt-4">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="product__item__text text-center">
                <h6><a href="">Puolilava uunikuivattua tammipolttopuuta</a></h6>
    ...
    <div class="col-md-6 col-lg-4 row mb-2 mt-4">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="product__item__text text-center">
                <h6><a href="">Kuiva puu valmiina poltettavaksi</a></h6>
    ...
    <div class="col-md-6 col-lg-4 row mb-2 mt-4">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="product__item__text text-center">
                <h6><a href="">40 pussia kuivattua saarnia 8 kg</a></h6>
    ...
    <div class="col-md-6 col-lg-4 row mb-2 mt-4">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="product__item__text text-center">
                <h6><a href="">40 pussia uunikuivattua leppäpuuta</a></h6>
    ...
    <div class="col-md-6 col-lg-4 row mb-2 mt-4">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="product__item__text text-center">
                <h6><a href="">5 pussia sytytystä</a></h6>
    ...
    <div class="col-md-6 col-lg-4 row mb-2 mt-4">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="product__item__text text-center">
                <h6><a href="">RUF-lava 1000 kg</a></h6>
    ...
    <div class="col-md-6 col-lg-4 row mb-2 mt-4">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="product__item__text text-center">
                <h6><a href="">Nestro pyökki- ja tammibriketit 300 kg</a></h6>
