    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            <div class="d-flex flex-wrap col-4 ">
                 <img  id="myImage" src="/images/20.jpg" class="d-none d-md-flex d-sm-flex" style="max-height:250px; ">
                <img  id="myImage" src="/images/20.jpg" class="d-sm-none d-md-none" style="max-height:150px; ">
            
            
            </div>
            <div class="m-4 d-flex flex-row flex-wrap">
               
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage2()"><img src="/images/20.jpg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage3()"><img src="/images/201.jpg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            <div class="mb-2 mx-4"><h3 style="color: #F49122; margin-bottom:20px;">Säilytysastia 20′ Uusi</h3></div>
            ...
            <p class="mx-4">
             <ul>
                    ...
                    <li><span class="text-primary">Paino:</span>  2000kg</li>
                    <li><span class="text-primary"> Suurin kuormauspaino:</span>28 480 kg</li>
               </ul>
