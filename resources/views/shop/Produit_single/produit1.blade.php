...
<html lang="fi">
    ...
    <script>
        ...
        var image = document.getElementById('myImage');
            ...
            image.src = '/images/8pieds.jpg';
        
        }
        function changeImage2() {
        var image = document.getElementById('myImage');
       
            image.src = '/images/8piedss.jpg';
    ...
    <div class="container-fluid position-relative p-0">
        ...
        <style>
            .bg-headerss
            {
                ...
                background: url('../images/cc.jpg') center center no-repeat;
    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            <div class="d-flex flex-wrap col-4 ">
                ...
                <img  id="myImage" src="/images/8piedss.jpg" class="d-none d-md-flex d-sm-flex" style="max-height:250px; ">
                <img  id="myImage" src="/images/8piedss.jpg" class="d-sm-none d-md-none" style="max-height:150px; ">
            
            
            </div>
            <div class="m-4 d-flex flex-row flex-wrap">
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage1()"><img src="/images/8pieds.jpg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage2()"><img src="/images/8piedss.jpg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            <div class="mb-2 mx-4"><h3 style="color: #F49122; margin-bottom:20px;">Säilytysastia 8′ Uusi</h3></div>
            <div class="d-flex flex-row mb-2 flex-wrap mx-4">
                ...
                <div class="mx-4"><h5 class="" style="color: #c5bebe">100 <span class=""style="color:black;">Tähtiarviointi</span></h5></div>
                <div class="ml-4"><h5 class="" style="color: #c5bebe">503 <span class="text-primary">Myyty</span></h5></div>
                


            </div>
            <div class="mb-2 mx-4">  <h3 class="text-primary">1300€ HT</h3></div>

            <p class="mx4">
                <ul>
                    <li><span class="text-primary">Tyyppi: </span>Tankit</li>
                    <li><span class="text-primary">Korkeus: </span>2,44 metriä (8')</li>
                    <li><span class="text-primary">Säiliön tyyppi: </span>Varastointi</li>
                    <li><span class="text-primary">Viite: </span>DEVCONTSTK8</li>
               </ul>
