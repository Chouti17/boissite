...
<body>
    ...
    <script>
        ...
        var image = document.getElementById('myImage');
            ...
            image.src = '/images/401.jpg';
        
        }
        function changeImage3() {
        var image = document.getElementById('myImage');
       
            image.src = '/images/402.jpg';
    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            <div class="d-flex flex-wrap col-4 ">
                ...
                <img  id="myImage" src="/images/401.jpg" class="d-none d-md-flex d-sm-flex" style="max-height:250px; ">
                <img  id="myImage" src="/images/401.jpg" class="d-sm-none d-md-none" style="max-height:150px; ">
            
           
            </div>
            <div class="m-4 d-flex flex-row flex-wrap">
               
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage2()"><img src="/images/401.jpg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage3()"><img src="/images/402.jpg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage1()"><img src="/images/404.jpg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            <div class="mb-2 mx-4"><h3 style="color: #F49122; margin-bottom:20px;">Säilytysastia 40′ Uusi</h3></div>
            ...
            <p class="mx-4">Tavallinen 40 jalan kontti
                Tavallinen 40 jalan konttimme on yksi suosituimmista. Siinä on kiinteä puulattia ja CSC-sertifioitu, joten se on valmis intermodaalisiin seikkailuihin. Älä aio mennä minnekään. Tavallinen 40 jalan konttimme täyttää tehtävänsä, olipa kyseessä kuljetus tai varastointi paikan päällä.
                 Lisäksi se täyttää ISO-standardit. Löydä tämä kontti ja monet muut myytävänä tai vuokrattavana verkkokaupastamme.</p>

            <p class="mx-4">
             <ul>   <h5>Ulkomitat</h5>
                    <li><span class="text-primary">Pituus </span> 12192mm</li>
                    <li><span class="text-primary">Leveys</span> 2438mm</li>
                    <li><span class="text-primary">Korkeus</span> 2591mm </li>
                    <li><span class="text-primary"> Taarakuorma  </span>max</li>
