...
<body>
    ...
    <div class="container-fluid position-relative p-0">
        ...
        <style>
            ...
            background: linear-gradient(rgba(9, 30, 62, .7), rgba(9, 30, 62, .7)), url('./images/cc2.jpg') center center no-repeat;
    ...
    <script>
        ...
        var image = document.getElementById('myImage');
            ...
            image.src = '/images/10dry.jpg';
        
        }
        function changeImage2() {
        var image = document.getElementById('myImage');
       
            image.src = '/images/10pids1.jpeg';
        
        }
        function changeImage3() {
        var image = document.getElementById('myImage');
       
            image.src = '/images/10pids2.jpeg';
    ...
    <div class="container d-flex flex-row flex-wrap " style="margin-top:100px;">
        <div class="col-md-6"> 
            <div class="d-flex flex-wrap col-4 ">
                <img  id="myImage" src="/images/10dry.jpg" class="d-none d-md-flex d-sm-flex" style="max-height:250px; ">
                <img  id="myImage" src="/images/10dry.jpg" class="d-sm-none d-md-none" style="max-height:150px; ">
            </div>
            <div class="m-4 d-flex flex-row flex-wrap">
                <div class="border m-4  " style="width: 120px; height:100px;" onclick="changeImage1()"><img src="/images/10dry.jpg" alt="" style="background-size: contain;height:80px;" class="p-3"></div>
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage2()"><img src="/images/10pids1.jpeg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
                <div class="border m-4  " style="width: 100px; height:100px;" onclick="changeImage3()"><img src="/images/10pids2.jpeg" alt="" style="background-size: cover;height:80px;" class="p-3"></div>
        ...
        <div class="col-md-6 d-flex flex-column ml-2">
            <div class="mb-2 mx-4"><h3 style="color: #F49122; margin-bottom:20px;">Säilytysastia 10′ Uusi</h3></div>
            ...
            <p class="mx-4">
             <ul>
                    <li><span class="text-primary">Pinta-ala: </span>7,3 m²</li>
                    <li><span class="text-primary">Pituus: </span>2,99m</li>
                    <li><span class="text-primary">Tilavuus: </span>15,76 m3</li>
                    <li><span class="text-primary">Paino: </span>825 kg</li>
               </ul>
